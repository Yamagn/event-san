...
var map = {
	"../pages/bookmark/bookmark.module": [
		280,
		3
	],
...
var BookmarkProvider = /** @class */ (function () {
    ...
    BookmarkProvider.prototype.get = function () {
        return this.storage.get("bookmark.events").then(function (events) {
            return events ? events : {};
        });
    };
    BookmarkProvider.prototype.put = function (event) {
        var _this = this;
        return this.get().then(function (events) {
            events[event.event_id] = event;
            return _this.storage.set("bookmark.events", events);
        });
    };
    BookmarkProvider.prototype.delete = function (event) {
        var _this = this;
        return this.get().then(function (events) {
...
var EventProvider = /** @class */ (function () {
    ...
    EventProvider.prototype.search = function (keywords) {
        var params = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpParams */]()
            .append('order', '2')
            .append('count', '100');
        keywords.forEach(function (kwd) { return params = params.append('keyword', "" + kwd); });
        return this.http.get("/connpass/api", { params: params });
    };
    EventProvider.prototype.get = function (eventId) {
        var params = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpParams */]()
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_home_home__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_event_event__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_bookmark_bookmark__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_common_locales_ja__ = __webpack_require__(279);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
Object(__WEBPACK_IMPORTED_MODULE_2__angular_common__["i" /* registerLocaleData */])(__WEBPACK_IMPORTED_MODULE_12__angular_common_locales_ja__["a" /* default */]);
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["c" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_8__app_component__["a" /* MyApp */], {}, {
                    links: [
                        { loadChildren: '../pages/bookmark/bookmark.module#BookmarkPageModule', name: 'BookmarkPage', segment: 'bookmark', priority: 'low', defaultHistory: [] },
            ...
            providers: [
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["G" /* LOCALE_ID */], useValue: navigator.language },
                __WEBPACK_IMPORTED_MODULE_10__providers_event_event__["a" /* EventProvider */],
                __WEBPACK_IMPORTED_MODULE_11__providers_bookmark_bookmark__["a" /* BookmarkProvider */]
            ],
        })
    ], AppModule);
    return AppModule;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/ymgn/ionicDir/event-san/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/ymgn/ionicDir/event-san/src/app/app.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/ymgn/ionicDir/event-san/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Ionic Blank\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  The world is your oyster.\n  <p>\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will be your guide.\n  </p>\n</ion-content>\n'/*ion-inline-end:"/Users/ymgn/ionicDir/event-san/src/pages/home/home.html"*/
        }),
